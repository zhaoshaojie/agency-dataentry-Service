...
import com.announce.dataentry.operation.domian.secondrequest.SubAgencyInfo;
...
@NoArgsConstructor
@Builder
public class SendsubAgencyRequestVo {
     ...
     * 转委托机构的详情列表
     */
    private List<SubAgencyInfo> subAgencyInfoList;
